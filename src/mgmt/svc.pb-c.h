...
typedef struct Mgmt__DaosResp                   Mgmt__DaosResp;
typedef struct Mgmt__GroupUpdateReq             Mgmt__GroupUpdateReq;
typedef struct Mgmt__GroupUpdateReq__Engine     Mgmt__GroupUpdateReq__Engine;
typedef struct Mgmt__GroupUpdateResp            Mgmt__GroupUpdateResp;
typedef struct Mgmt__JoinReq                    Mgmt__JoinReq;
typedef struct Mgmt__JoinResp                   Mgmt__JoinResp;
typedef struct Mgmt__LeaderQueryReq             Mgmt__LeaderQueryReq;
typedef struct Mgmt__LeaderQueryResp            Mgmt__LeaderQueryResp;
typedef struct Mgmt__GetAttachInfoReq           Mgmt__GetAttachInfoReq;
typedef struct Mgmt__ClientNetHint              Mgmt__ClientNetHint;
typedef struct Mgmt__FabricInterface            Mgmt__FabricInterface;
typedef struct Mgmt__FabricInterfaces           Mgmt__FabricInterfaces;
typedef struct Mgmt__BuildInfo                  Mgmt__BuildInfo;
typedef struct Mgmt__GetAttachInfoResp          Mgmt__GetAttachInfoResp;
typedef struct Mgmt__GetAttachInfoResp__RankUri Mgmt__GetAttachInfoResp__RankUri;
typedef struct Mgmt__PrepShutdownReq            Mgmt__PrepShutdownReq;
typedef struct Mgmt__PingRankReq                Mgmt__PingRankReq;
typedef struct Mgmt__SetRankReq                 Mgmt__SetRankReq;
typedef struct Mgmt__PoolMonitorReq             Mgmt__PoolMonitorReq;
typedef struct Mgmt__ClientTelemetryReq         Mgmt__ClientTelemetryReq;
typedef struct Mgmt__ClientTelemetryResp        Mgmt__ClientTelemetryResp;
...
struct Mgmt__GroupUpdateReq__Engine {
	ProtobufCMessage base;
	uint32_t         rank;
	/*
...
struct Mgmt__GetAttachInfoResp__RankUri {
	ProtobufCMessage base;
	uint32_t         rank;
	char            *uri;
	uint32_t         provider_idx;
...
struct Mgmt__GetAttachInfoResp {
	ProtobufCMessage                   base;
	/*
	 * DAOS error code
	 */
...
struct Mgmt__ClientTelemetryReq {
	ProtobufCMessage base;
	/*
	 * DAOS system identifier
	 */
...
struct Mgmt__ClientTelemetryResp {
	ProtobufCMessage base;
	/*
	 * DAOS status code
	 */
